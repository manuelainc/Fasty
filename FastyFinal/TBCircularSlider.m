...
-(id)initWithFrame:(CGRect)frame{
    ...
    if(self){
        ...
        CGSize fontSize = [str sizeWithAttributes: @{NSFontAttributeName: [UIFont fontWithName:TB_FONTFAMILY size:TB_FONTSIZE]}];
...
//** Draw the circle (using a clipped gradient) **/
    ...
    CGFloat components[8] = {
        1, 1, 1, 1.0,     // Start color - Blue
        0.0, 0, 0, 1.0 };   // End color - Violet
